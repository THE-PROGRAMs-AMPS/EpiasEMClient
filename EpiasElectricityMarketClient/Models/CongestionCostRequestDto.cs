...
{
    public partial class CongestionCostRequestDto
    {
        /// <summary>
        ...
        public CongestionCostRequestDtoOrderType OrderType { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CongestionCostRequestDtoPriceType PriceType { get; set; }
