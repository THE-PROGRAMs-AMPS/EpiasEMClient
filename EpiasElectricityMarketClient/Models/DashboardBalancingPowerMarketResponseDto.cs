...
{
    public partial class DashboardBalancingPowerMarketResponseDto
    {
        [Newtonsoft.Json.JsonProperty("items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<DashboardBalancingPowerMarketDataDto> Items { get; set; }
