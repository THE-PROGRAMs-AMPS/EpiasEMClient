...
{
    public partial class PrimaryFrequencyCapacityAmountResponseDto
    {
        [Newtonsoft.Json.JsonProperty("items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<PrimaryFrequencyCapacityAmountDataDto> Items { get; set; }
