...
{
    public partial class SecondaryFrequencyCapacityPriceResponseDto
    {
        [Newtonsoft.Json.JsonProperty("items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<SecondaryFrequencyCapacityPriceDataDto> Items { get; set; }
